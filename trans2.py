...
path1 = 'weights/PPON_G.pth'
ckpt_tr = torch.load(path1,map_location=torch.device('cpu'))
# ckpt_tr = ckpt_tr['model']
path2 = 'E:\\github\\PPON_X4\\experiments\\PPON_x4\\models\\0_G.pdparams'
...
parser.add_argument('-opt', type=str, help='Path to options YMAL file.', default="E:\\github\\PPON_X4\\config\\train\\train_PPON_x4 .yml")
...
paddle.save(ckpt_pd, 'trans_weights/trans_PPON_x4.pdparams')
a = 1